...
/***/ function(module, exports) {
	...
	exports.default = function () {
	    ...
	    var actions = {
	        ...
	        SET_GRID_COLOR: function SET_GRID_COLOR() {
	            return Object.assign({}, state, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxActions = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createAction = __webpack_require__(189);
	
	var _createAction2 = _interopRequireDefault(_createAction);
	
	var _handleAction = __webpack_require__(190);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ownKeys = __webpack_require__(198);
	
	var _ownKeys2 = _interopRequireDefault(_ownKeys);
	
	var _reduceReducers = __webpack_require__(199);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	    ...
	    var result = state,
	        actions = {
	        SET_F_A: function SET_F_A() {
	            return Object.assign({}, state, {
	                func: params(state.func, action)
	            });
	        },
	        SET_F_T_MAX: function SET_F_T_MAX() {
	            return Object.assign({}, state, {
	                func: params(state.func, action)
	            });
	        },
	        SET_F_T_MIN: function SET_F_T_MIN() {
	            return Object.assign({}, state, {
	                func: params(state.func, action)
	            });
	        },
	        SET_F_COLOR: function SET_F_COLOR() {
	        ...
	        SET_F_INTERVAL: function SET_F_INTERVAL() {
	            return Object.assign({}, state, {
	                func: params(state.func, action)
	            });
	        },
	        SET_F_CTX: function SET_F_CTX() {
	            var options = Object.assign({}, state.options, {
	                ctx: action.ctx
	            });
	            return Object.assign({}, state, {
	...
	var Func = function () {
	    ...
	    _createClass(Func, [{
	        ...
	        get: function get() {
	            ...
	            if (y.length) {
	                result = {
	                    min: Math.min.apply(Math, _toConsumableArray(y)),
	                    max: Math.max.apply(Math, _toConsumableArray(y))
	                };
	            } else {
	                result = {
	                    min: 0,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DataSet = __webpack_require__(204);
	...
	exports.default = function () {
	    return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_DataSet2.default, null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Background = __webpack_require__(205);
	...
	exports.default = function () {
	    return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_Background2.default, { className: 'card' }),
	        _react2.default.createElement(_Axis2.default, { className: 'card' }),
	        _react2.default.createElement(_Func2.default, { className: 'card' })
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _field = __webpack_require__(206);
	
	var _Background = __webpack_require__(207);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        setBGColor: function setBGColor(color) {
	            dispatch((0, _field.setFIeldColor)(color));
	        },
	        setGridColor: function setGridColor(color) {
	            dispatch((0, _field.setGridColor)(color));
	        }
	    };
	};
	...
	var mapStateToProps = function mapStateToProps(state) {
	    ...
	    var bgColor = _state$field.bgColor;
	    var grColor = _state$field.grColor;
	
	    return {
	        bgColor: bgColor, grColor: grColor
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Paper = __webpack_require__(208);
	...
	exports.default = function (_ref) {
	    var setBGColor = _ref.setBGColor;
	    var setGridColor = _ref.setGridColor;
	    var bgColor = _ref.bgColor;
	    var grColor = _ref.grColor;
	    return _react2.default.createElement(
	        _Paper2.default,
	        { title: 'Background' },
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        changeColor: function changeColor(color) {
	            dispatch((0, _axis.setAxisColor)(color));
	        }
	    };
	};
	
	var mapStateToProps = function mapStateToProps(state) {
	    var color = state.axis.color;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Func = __webpack_require__(215);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        ...
	        getPoints: function getPoints(points) {
	            dispatch((0, _func.getPoints)(points));
	        }
	    };
	};
	
	var mapStateToProps = function mapStateToProps(state) {
	    var color = state.func.options.color;
	    var _state$func$func = state.func.func;
	    var a = _state$func$func.a;
	    var tMin = _state$func$func.tMin;
	    var tMax = _state$func$func.tMax;
	    var step = _state$func$func.step;
	    var options = state.func.func;
	    var getUpdatedParams = function getUpdatedParams(options) {
	...
	var Func = function (_React$Component) {
	    ...
	    _createClass(Func, [{
	        ...
	        value: function render() {
	            ...
	            var getPoints = _props.getPoints;
	            var getUpdatedParams = _props.getUpdatedParams;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_Func2.default, null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Field = __webpack_require__(218);
	...
	var mapStateToProps = function mapStateToProps(state) {
	    ...
	    var grColor = _state$field.grColor;
	    var bgColor = _state$field.bgColor;
	    var ctx = _state$field.ctx;
	    var _state$common$size = state.common.size;
	    var width = _state$common$size.width;
	    var height = _state$common$size.height;
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        setCtx: function setCtx(ctx) {
	            dispatch((0, _field.setFieldCtx)(ctx));
	        }
	    };
	};
	...
	var Field = function (_React$Component) {
	    ...
	    _createClass(Field, [{
	        ...
	        value: function drawGrid() {
	            var x;
	            var y;var _props2 = this.props;
	            var ctx = _props2.ctx;
	            var width = _props2.width;
	            var height = _props2.height;
	            var step = _props2.step;
	            var begin = _props2.begin;
	            var grColor = _props2.grColor;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Func = __webpack_require__(220);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Func = function (_React$Component) {
	    ...
	    function Func(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Func).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Axis = __webpack_require__(222);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        setCtx: function setCtx(ctx) {
	            dispatch((0, _axis.setAxisCtx)(ctx));
	        }
	    };
	};
	...
	var Axis = function (_React$Component) {
	    ...
	    _createClass(Axis, [{
	        ...
	        value: function drawXCoord() {
	            var _props$x = this.props.x;
	            var min = _props$x.min;
	            var max = _props$x.max;
	            var _props$size2 = this.props.size;
	            var height = _props$size2.height;
	            var width = _props$size2.width;
	            var _props = this.props;
	            ...
	            var ctx = _props.ctx;
	            var center = width / 2;
	            var x = min * step + center;
	            var y = height / 2;
	            var end = max * step + center;
	            var title = Math.round(min) + 1;
	        ...
	        value: function drawYCoord() {
	            var _props$y = this.props.y;
	            var min = _props$y.min;
	            var max = _props$y.max;
	            ...
	            var ctx = _props2.ctx;
	            var center = height / 2;
	            var y = center - max * step;
	            var x = width / 2;
	            var end = center + Math.abs(min) * step;
	            var title = Math.round(max) - 1;
	        ...
	        value: function clear() {
	            var ctx = this.props.ctx;
	            var _props$size4 = this.props.size;
	            var height = _props$size4.height;
	            var width = _props$size4.width;
